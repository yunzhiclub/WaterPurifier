...
public class LoginController {
    ...
    @GetMapping("/")
    public String Login(@ApiParam(value = "登录凭证") @RequestParam("code") String code, HttpSession session) {
        ...
        loginService.storeSession(threeRdSession, openIdAndSessionKey, session);
